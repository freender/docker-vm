...
3. Once flashed create en empty "SSH" file on ssd to allow SSH access, however you might needs to connect physically and create new user dutring first boot
